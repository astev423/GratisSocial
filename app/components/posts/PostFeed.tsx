...
import type { PostWithLikeInfo, TypeOfPostToView } from "@/lib/types/apiTypes"
...
export default function PostFeed({ postsToSee, username = undefined }: PostFeedProps) {
  ...
  const { data: posts, loading, error: _error } = useFetch<PostWithLikeInfo[]>(url, "GET", reloadPosts)
