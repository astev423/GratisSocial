...
import { LikeCreateNestedManyWithoutLikerInputObjectSchema as LikeCreateNestedManyWithoutLikerInputObjectSchema } from './LikeCreateNestedManyWithoutLikerInput.schema'
...
const makeSchema = () => z.object({
  ...
  likes: z.lazy(() => LikeCreateNestedManyWithoutLikerInputObjectSchema).optional()
}).strict();
export const UserCreateWithoutPostsByUsernameInputObjectSchema: z.ZodType<Prisma.UserCreateWithoutPostsByUsernameInput> = makeSchema() as unknown as z.ZodType<Prisma.UserCreateWithoutPostsByUsernameInput>;
export const UserCreateWithoutPostsByUsernameInputObjectZodSchema = makeSchema();
