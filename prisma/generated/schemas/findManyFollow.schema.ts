...
export const FollowFindManySelectSchema: z.ZodType<Prisma.FollowSelect> = z.object({
...
export const FollowFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    follower: z.boolean().optional(),
    followerId: z.boolean().optional(),
    personFollowed: z.boolean().optional(),
...
export const FollowFindManySchema: z.ZodType<Prisma.FollowFindManyArgs> = z.object({ select: FollowFindManySelectSchema.optional(), include: z.lazy(() => FollowIncludeObjectSchema.optional()), orderBy: z.union([FollowOrderByWithRelationInputObjectSchema, FollowOrderByWithRelationInputObjectSchema.array()]).optional(), where: FollowWhereInputObjectSchema.optional(), cursor: FollowWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FollowScalarFieldEnumSchema, FollowScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FollowFindManyArgs>;

export const FollowFindManyZodSchema = z.object({ select: FollowFindManySelectSchema.optional(), include: z.lazy(() => FollowIncludeObjectSchema.optional()), orderBy: z.union([FollowOrderByWithRelationInputObjectSchema, FollowOrderByWithRelationInputObjectSchema.array()]).optional(), where: FollowWhereInputObjectSchema.optional(), cursor: FollowWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FollowScalarFieldEnumSchema, FollowScalarFieldEnumSchema.array()]).optional() }).strict();