...
export const FollowFindFirstSelectSchema: z.ZodType<Prisma.FollowSelect> = z.object({
...
export const FollowFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    follower: z.boolean().optional(),
    followerId: z.boolean().optional(),
    personFollowed: z.boolean().optional(),
...
export const FollowFindFirstSchema: z.ZodType<Prisma.FollowFindFirstArgs> = z.object({ select: FollowFindFirstSelectSchema.optional(), include: z.lazy(() => FollowIncludeObjectSchema.optional()), orderBy: z.union([FollowOrderByWithRelationInputObjectSchema, FollowOrderByWithRelationInputObjectSchema.array()]).optional(), where: FollowWhereInputObjectSchema.optional(), cursor: FollowWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FollowScalarFieldEnumSchema, FollowScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FollowFindFirstArgs>;

export const FollowFindFirstZodSchema = z.object({ select: FollowFindFirstSelectSchema.optional(), include: z.lazy(() => FollowIncludeObjectSchema.optional()), orderBy: z.union([FollowOrderByWithRelationInputObjectSchema, FollowOrderByWithRelationInputObjectSchema.array()]).optional(), where: FollowWhereInputObjectSchema.optional(), cursor: FollowWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FollowScalarFieldEnumSchema, FollowScalarFieldEnumSchema.array()]).optional() }).strict();